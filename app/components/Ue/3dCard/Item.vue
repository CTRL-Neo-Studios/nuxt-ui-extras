...
/**
 * Heavy Disclaimer: I DO NOT OWN THIS COMPONENT. THE ORIGINAL IS FROM https://inspira-ui.com/docs/en/components/cards/3d-card
...
const mouseState = inject("use3DCardMouseState") as ReturnType<typeof useUeMouseState>;
