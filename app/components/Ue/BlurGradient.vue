...
const positions = computed(() => {
	switch (props.direction) {
		case 'bottom': return { hidden: '0% 0%', revealed: '0% 100%' }
		case 'top': return { hidden: '0% 100%', revealed: '0% 0%' }
		case 'right': return { hidden: '0% 0%', revealed: '100% 0%' }
		case 'left': return { hidden: '100% 0%', revealed: '0% 0%' }
	}
})
