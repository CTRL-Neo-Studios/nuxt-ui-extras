...
import { mergeI18nConfig, getDefaultOperatorForFieldType } from '../../../../shared/utils/operators'
import { flattenFieldsConfig, getFieldsMap } from '../../../../shared/utils/fields'
import FilterContextProvider from './ContextProvider.vue'
import FilterItem from './Item.vue'
import AddFilterPopover from './AddFilterPopover.vue'
...
function getDefaultOperatorForField(field: FilterFieldConfig): FilterOperatorValue {
	return getDefaultOperatorForFieldType(field.type || 'custom', field.defaultOperator)
}
